...
name = input ("What's your name?") #This stores the users name

print ("\nOK, " +  name +", let's start.  Please Remember, the following answers are only True or False. and accepts either the letters T or F or the full words, true or false")
print ("\nGood luck!!")
time.sleep(2)
